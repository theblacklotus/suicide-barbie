...
class KFbxConstraintPosition_internal;
class KFbxVector4;
...
{
	KFBXOBJECT_DECLARE(KFbxConstraintPosition);
...
public:
	...
	/** Get the weight of a source.
	  * \param Object that we want the weight.
	  */
...
protected:
	...
	KFbxConstraintPosition_internal* mPH;
