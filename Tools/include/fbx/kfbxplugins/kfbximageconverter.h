...
{
	KFBXOBJECT_DECLARE(KFbxImageConverter);
...
// global utilities
bool IsCompressedTif(KString pFile);
bool ReadFromTif(KString pFile, ImageConverterBuffer& pBuffer, bool deleteFile);
bool WriteToTif(KString pFile, bool pCompressed, ImageConverterBuffer& pBuffer);
