...
public:
	...
	: mMallocHandler(pMallocHandler), mCallocHandler(pCallocHandler),
	  mReallocHandler(pReallocHandler), mFreeHandler(pFreeHandler)						  
	{
	}
...
/** Default implementation of memory allocator.
  ...
  */
class KFbxDefaultMemoryAllocator : public KFbxMemoryAllocator
{
public:
