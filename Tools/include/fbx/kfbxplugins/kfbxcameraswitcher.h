...
#include <fbxfilesdk_nsbegin.h>
	...
	class KFbxCameraSwitcher_internal;
	...
	{
		KFBXOBJECT_DECLARE(KFbxCameraSwitcher);
    ...
    KFbxCameraSwitcher& operator=(KFbxCameraSwitcher const& pCameraIndex);
		...
		/** Add channels specific to a camera switcher attribute.
		  * \param pTakeNode Take node to add specialized channels to.
		  */
		virtual void AddChannels(KFbxTakeNode *pTakeNode);

		/** Remove channels specific to a camera switcher attribute.
		...
		KFbxCameraSwitcher_internal* mPH;
