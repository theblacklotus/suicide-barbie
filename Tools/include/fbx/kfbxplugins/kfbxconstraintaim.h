...
#include <fbxfilesdk_nsbegin.h>
	...
	class KFbxConstraintAim_internal;
	...
	{
		KFBXOBJECT_DECLARE(KFbxConstraintAim);
	...
	protected:
		...
		KFbxConstraintAim_internal* mPH;
