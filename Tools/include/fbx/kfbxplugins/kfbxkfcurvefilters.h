...
{
	KFBXOBJECT_DECLARE(KFbxKFCurveFilters);
...
public:	
	...
	* \param pCurveNode     Array of Curves to test if it needs application of filter
...
{
	KFBXOBJECT_DECLARE(KFbxKFCurveFilterConstantKeyReducer);
...
{
	KFBXOBJECT_DECLARE(KFbxKFCurveFilterMatrixConverter);
...
{
	KFBXOBJECT_DECLARE(KFbxKFCurveFilterResample);
...
{
	KFBXOBJECT_DECLARE(KFbxKFCurveFilterUnroll);
