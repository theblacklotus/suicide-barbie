...
{
	KFBXOBJECT_DECLARE(KFbxStreamOptionsColladaReader);
...
public:
	...
	* \remarks                    If pTimeMode is set to KTime::eDEFAULT_MODE, pCustomFrameRate is used instead.
	*/
...
{
	KFBXOBJECT_DECLARE(KFbxStreamOptionsColladaWriter);
