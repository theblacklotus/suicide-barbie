...
void DisplayChannels(KFbxNode* pNode, KFbxTakeNode* pTakeNode, 
					 void (*DisplayCurve) (KFCurve *pCurve), 
					 void (*DisplayListCurve) (KFCurve *pCurve, KFbxUserProperty* pProperty), 
					 bool isSwitcher);
void DisplayCurveKeys(KFCurve *pCurve);
void DisplayCurveDefault(KFCurve *pCurve);
void DisplayListCurveKeys(KFCurve *pCurve, KFbxUserProperty* pProperty);
void DisplayListCurveDefault(KFCurve *pCurve, KFbxUserProperty* pProperty);
...
void DisplayDefaultAnimation(KFbxNode* pNode)
{
	...
	if(lDefaultTakeNode)
	{
		DisplayChannels(pNode, lDefaultTakeNode, DisplayCurveDefault, DisplayListCurveDefault, false);
	}

	printf ("\n");
}

void DisplayChannels(KFbxNode* pNode, KFbxTakeNode* pTakeNode, void (*DisplayCurve) (KFCurve *pCurve), void (*DisplayListCurve) (KFCurve *pCurve, KFbxUserProperty* pProperty), bool isSwitcher)
{
	KFCurve* lCurve = NULL;
	...
	for (i=0; i<lCount; i++)
	{
		...
		KFbxUserProperty::EUserPropertyType lEUserPropertyType= DataTypeToEUserPropertyType(lDataType);
		switch (lEUserPropertyType)
		{
			...
			{
				char* lComponentName1 = lEUserPropertyType == KFbxUserProperty::eCOLOR ? (char*)KFCURVENODE_COLOR_RED : (char*)"X";
				char* lComponentName2 = lEUserPropertyType == KFbxUserProperty::eCOLOR ? (char*)KFCURVENODE_COLOR_GREEN : (char*)"Y";
				char* lComponentName3 = lEUserPropertyType == KFbxUserProperty::eCOLOR ? (char*)KFCURVENODE_COLOR_BLUE  : (char*)"Z";
			...
			case KFbxUserProperty::eLIST:
			{
				...
				DisplayString(lMessage.Buffer());
				DisplayListCurve(lCurve, &lProperty);
			}
			break;
		}
	}
...
void DisplayListCurveDefault(KFCurve *pCurve, KFbxUserProperty*)
{
