...
class FBXSDK_NAMESPACE::KFbxCamera;

void DisplayCamera(FBXSDK_NAMESPACE::KFbxCamera* pCamera, char* pName, FBXSDK_NAMESPACE::KFbxNode* pTargetNode = NULL, FBXSDK_NAMESPACE::KFbxNode* pTargetUpNode = NULL);
void DisplayCamera(FBXSDK_NAMESPACE::KFbxNode* pNode);
