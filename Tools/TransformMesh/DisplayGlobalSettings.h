...
// Forward declaration.
class FBXSDK_NAMESPACE::KFbxGlobalLightSettings;
class FBXSDK_NAMESPACE::KFbxGlobalCameraSettings;
class FBXSDK_NAMESPACE::KFbxGlobalTimeSettings;


void DisplayGlobalLightSettings(FBXSDK_NAMESPACE::KFbxGlobalLightSettings* pGlobalLightSettings);
void DisplayGlobalCameraSettings(FBXSDK_NAMESPACE::KFbxGlobalCameraSettings* pGlobalCameraSettings);
void DisplayGlobalTimeSettings(FBXSDK_NAMESPACE::KFbxGlobalTimeSettings* pGlobalTimeSettings);
