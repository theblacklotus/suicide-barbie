...
CTransform const& CTransform::operator=( t_matrix const& m )
{
	...
	} else
	{
		if( mat34_ij( rotM, 0, 0 ) > mat34_ij( rotM, 1, 1 ) && 
			...
			S  = mathSqrt( 1.0f + mat34_ij( rotM, 0, 0 ) - mat34_ij( rotM, 1, 1 ) - mat34_ij( rotM, 2, 2 ) ) * 2;
			X = 0.25f * S;
			...
			S  = mathSqrt( 1.0f + mat34_ij( rotM, 1, 1 ) - mat34_ij( rotM, 0, 0 ) - mat34_ij( rotM, 2, 2 ) ) * 2;
			X = (mat34_ij( rotM, 0, 1 ) + mat34_ij( rotM, 1, 0 ) ) / S;
			Y = 0.25f * S;
			Z = (mat34_ij( rotM, 1, 2 ) + mat34_ij( rotM, 2, 1 ) ) / S;
			W = (mat34_ij( rotM, 2, 0 ) - mat34_ij( rotM, 0, 2 ) ) / S;
		} else {						// Column 2:
			S  = mathSqrt( 1.0f + mat34_ij( rotM, 2, 2 ) - mat34_ij( rotM, 0, 0 ) - mat34_ij( rotM, 1, 1 ) ) * 2;
